...
public record CreateImageRequest(
  ...
  public static class Builder {
    ...
    private Optional<String> moderation = Optional.empty();
    private Optional<Integer> n = Optional.empty();
    private Optional<Integer> outputCompression = Optional.empty();
    ...
    /**
     * @param background Set transparency for the background of the generated images.
     */
    ...
    /**
     * @param moderation Set the content-moderation level for images generated by gpt-image-1.
     */
    public Builder moderation(String moderation) {
      this.moderation = Optional.of(moderation);
      return this;
    }
    ...
    /**
     * @param outputCompression The compression level (0-100%) for the generated images.
     */
    public Builder outputCompression(int outputCompression) {
      this.outputCompression = Optional.of(outputCompression);
      return this;
    }
